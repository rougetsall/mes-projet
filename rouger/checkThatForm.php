...
$liste=["prenom","nom","email","age","bachelor","mdp","rmdp"];
	             foreach ($liste as $key => $value) {
					...
					if (!ctype_alpha($_POST["nom"])){
                     ...
                     if (isset($_POST["voyageur"])) {
                     	foreach ($_POST["voyageur"] as $key => $value) {
                     		# code...
                     		$tome=$value;
                     	}
                     	
                     }
                     elseif (!isset($_POST["voyageur"])) {
                     	# code...
...
<body>
			    	...
			    	<div style="margin: auto;background-color: blue; margin-top:15%;">
						<table style="margin: auto;" border="1">
							...
							<tr>
								...
								<td><?php foreach ($_POST["voyageur"] as $key => $value) {
									echo $value;
									if ($key!=sizeof($_POST["voyageur"])-1) {
										# code...
										echo ", <br>";
									}
								}
                   ...
                   <?php  }?><a href="http://localhost:8888/LDP4sall.abdourahmane/%20checkThatForm/%20index.html" >Retour</a>
